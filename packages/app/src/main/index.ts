...
function registerIpc(): void {
  ...
  // A pasted image: written into a `<docname>.assets/` folder next to the doc (Typora-style),
  // committed to git alongside it — never the sidecar dir, so the Markdown link it produces
  // stays valid for anyone who clones the repo, not just this machine.
